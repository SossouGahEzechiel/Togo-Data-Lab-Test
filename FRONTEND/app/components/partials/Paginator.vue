		...
		<div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
			<div>
				<p class="text-sm text-gray-700 dark:text-gray-300">
					...
					<span class="font-medium">{{ Math.min(endIndex, filteredDataCount) }}</span> sur
					<span class="font-medium">{{ filteredDataCount }}</span> résultats
				</p>
			</div>
			<div>
